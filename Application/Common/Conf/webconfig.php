...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '陕ICP备17021730',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'weizs.go@foxmail.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '正山博客',             //网站名：
    'WEB_KEYWORDS'              =>  '正山,技术博客,个人博客,wzsblog',         //网站关键字
    'WEB_DESCRIPTION'           =>  '正山的个人技术博客,wzsblog官方网站',      //网站描述
    'AUTHOR'                    =>  '正山',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为正山原创文章,转载无需和我联系,但请注明来自正山博客wzsblog.com',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '正山博客', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'wzsblog.com',      //文字水印内容
